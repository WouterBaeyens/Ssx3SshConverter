 ...
 */
public class Filler2Tag extends ImgSubComponent {
    ...
    private static final byte[] BUY_ERTS_AS_BYTE = {0x00};
    ...
    public Filler2Tag(final RandomAccessFile file, final long startPosition) throws IOException {
        this(file, startPosition, getNeededFillerSize(startPosition));
    }

    public Filler2Tag(final RandomAccessFile file, final long startPosition, long actualSize) throws IOException {

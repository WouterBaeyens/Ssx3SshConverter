...
public class Interleafed2DecoderStrategy implements SshImageDecoderStrategy{
    ...
    static{
        ...
        m5.put(new Point(2, 10), new Point(1,0));
        m5.put(new Point(2, 11), new Point(1,1));
        ...
        m5.put(new Point(3, 2), new Point(1,10));
        m5.put(new Point(3, 3), new Point(1,11));
        ...
        m5.put(new Point(1, 6), new Point(2,4));
        m5.put(new Point(1, 7), new Point(2,5));
        m5.put(new Point(1, 2), new Point(2,6));
        ...
        m5.put(new Point(1, 10), new Point(2,14));
        m5.put(new Point(1, 11), new Point(2,15));
        ...
        m5.put(new Point(3, 12), new Point(3,8));
        m5.put(new Point(3, 13), new Point(3,9));

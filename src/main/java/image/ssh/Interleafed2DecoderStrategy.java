...
public class Interleafed2DecoderStrategy implements SshImageDecoderStrategy{
    ...
    static{
        ...
        m5.put(new Point(5, 8), new Point(4,6));
        m5.put(new Point(5, 9), new Point(4,7));
        ...
        m5.put(new Point(7, 8), new Point(5,6));
        m5.put(new Point(7, 9), new Point(5,7));
        ...
        m5.put(new Point(8, 4), new Point(10,2));
        m5.put(new Point(8, 5), new Point(10,3));
        m5.put(new Point(8, 14), new Point(10,4));
        m5.put(new Point(8, 15), new Point(10,5));

...
public class Interleafed2DecoderStrategy implements SshImageDecoderStrategy{
    ...
    static{
        ...
        m5.put(new Point(1, 10), new Point(2,4));
        m5.put(new Point(1, 11), new Point(2,5));
        ...
        m5.put(new Point(2, 14), new Point(3,4));
        m5.put(new Point(2, 15), new Point(3,5));
        ...
        m5.put(new Point(4, 8), new Point(4,4));
        m5.put(new Point(4, 9), new Point(4,5));
        ...
        m5.put(new Point(6, 8), new Point(5,4));
        m5.put(new Point(6, 9), new Point(5,5));

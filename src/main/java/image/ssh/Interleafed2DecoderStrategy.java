...
public class Interleafed2DecoderStrategy implements SshImageDecoderStrategy{
    ...
    static{
        ...
        m5.put(new Point(3, 2), new Point(1,4));
        m5.put(new Point(3, 3), new Point(1,5));
        m5.put(new Point(3, 0), new Point(1,6));
        m5.put(new Point(3, 1), new Point(1,7));
        ...
        m5.put(new Point(3, 10), new Point(1,12));
        m5.put(new Point(3, 11), new Point(1,13));
        m5.put(new Point(3, 8), new Point(1,14));
        m5.put(new Point(3, 9), new Point(1,15));


        m5.put(new Point(1, 6), new Point(2,0));
        m5.put(new Point(1, 7), new Point(2,1));
        m5.put(new Point(1, 4), new Point(2,2));
        m5.put(new Point(1, 5), new Point(2,3));
        ...
        m5.put(new Point(1, 14), new Point(2,8));
        m5.put(new Point(1, 15), new Point(2,9));
        m5.put(new Point(1, 12), new Point(2,10));
        m5.put(new Point(1, 13), new Point(2,11));
        ...
        m5.put(new Point(1, 2), new Point(3,2));
        m5.put(new Point(1, 3), new Point(3,3));
        ...
        m5.put(new Point(1, 10), new Point(3,10));
        m5.put(new Point(1, 11), new Point(3,11));
        ...
        m5.put(new Point(5, 14), new Point(6,12));
        m5.put(new Point(5, 15), new Point(6,13));
        ...
        m5.put(new Point(7, 14), new Point(7,12));
        m5.put(new Point(7, 15), new Point(7,13));
        ...
        m5.put(new Point(9, 10), new Point(8,12));
        m5.put(new Point(9, 11), new Point(8,13));
        ...
        m5.put(new Point(11, 10), new Point(9,12));
        m5.put(new Point(11, 11), new Point(9,13));
        m5.put(new Point(11, 8), new Point(9,14));
        m5.put(new Point(11, 9), new Point(9,15));

        m5.put(new Point(8, 12), new Point(10,0));
        m5.put(new Point(8, 13), new Point(10,1));
        m5.put(new Point(8, 14), new Point(10,2));
        m5.put(new Point(8, 15), new Point(10,3));
        ...
        m5.put(new Point(10, 12), new Point(11,4));
        m5.put(new Point(10, 13), new Point(11,5));
        ...
        m5.put(new Point(12, 8), new Point(12,0));
        m5.put(new Point(12, 9), new Point(12,1));
        m5.put(new Point(12, 0), new Point(12,2));
        m5.put(new Point(12, 1), new Point(12,3));
        ...
        m5.put(new Point(13, 0), new Point(12,10));
        m5.put(new Point(13, 1), new Point(12,11));
        ...
        m5.put(new Point(14, 8), new Point(13,0));
        m5.put(new Point(14, 9), new Point(13,1));
        m5.put(new Point(14, 0), new Point(13,2));
        m5.put(new Point(14, 1), new Point(13,3));
        ...
        m5.put(new Point(15, 0), new Point(13,10));
        m5.put(new Point(15, 1), new Point(13,11));
        ...
        m5.put(new Point(13, 4), new Point(14,8));
        m5.put(new Point(13, 5), new Point(14,9));
        m5.put(new Point(13, 6), new Point(14,10));
        m5.put(new Point(13, 7), new Point(14,11));
        m5.put(new Point(13, 14), new Point(14,12));
        m5.put(new Point(13, 15), new Point(14,13));
        ...
        m5.put(new Point(15, 4), new Point(15,8));
        m5.put(new Point(15, 5), new Point(15,9));
        m5.put(new Point(15, 6), new Point(15,10));
        m5.put(new Point(15, 7), new Point(15,11));
        m5.put(new Point(15, 14), new Point(15,12));
        m5.put(new Point(15, 15), new Point(15,13));
